...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { comments: @release.comments, name: @release.name, release_date: @release.release_date, release_gate_id: @release.release_gate_id } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { comments: @release.comments, name: @release.name, release_date: @release.release_date, release_gate_id: @release.release_gate_id } }
